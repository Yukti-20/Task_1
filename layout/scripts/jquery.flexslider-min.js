 ...
 */!function($)
 {
	 ...
	 $.flexslider=function(t,a)
	 {
		 ...
		 f={};
		 $.data(t,"flexslider",n),
		 f={init:function(){n.animating=!1,n.currentSlide=parseInt(n.vars.startAt?n.vars.startAt:0,10),
		 ...
		 n.count=n.slides.length,n.syncExists=$(n.vars.sync).length>0,"slide"===n.vars.animation&&(n.vars.animation="swing"),
		 ...
		 n.vars.randomize&&(n.slides.sort(function(){return Math.round(Math.random())-.5}),
		 ...
		 n.vars.mousewheel&&n.bind("mousewheel",function(e,t,a,i)
		 {
			 ...
			 n.vars.slideshow&&(n.vars.pauseOnHover&&n.hover(function()
			 {
				 ...
				 n.find("img").attr("draggable","false"),setTimeout(function(){n.vars.start(n)},200)
			 },
			 asNav:{setup:function()
			 {
				 ...
				 n.slides.removeClass(i+"active-slide").eq(n.currentItem).addClass(i+"active-slide"),s?(t._slider=n,n.slides.each(function()
				 {
					 var e=this;
					 e._gesture=new MSGesture,e._gesture.target=e,
...
$('.basicslider').flexslider({
	...
	pauseOnHover: true,
	controlNav: true,
	directionNav: false,/* CSS has to be created if required */
	smoothHeight: true,
